...
// Define a `name` variable. Use it as an argument after updating logEvent and logTime - done not sure what's going on with the word event but it runs in the terminal.
